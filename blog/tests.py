...
class WelcomePageTest(TestCase):
    ...
    def test_displays_all_list_items(self):
        Item.objects.create(company='Tesco', role='cashier', text='Worked in a shop', startDate=datetime.datetime(2020, 5, 17), endDate=datetime.datetime(2020, 6, 25))
        Item.objects.create(company='Waitrose', role='Manager', text='Worked in another shop', startDate=datetime.datetime(2020, 5, 17), endDate=datetime.datetime(2020, 6, 25))

        response = self.client.get('/cv/view/')
